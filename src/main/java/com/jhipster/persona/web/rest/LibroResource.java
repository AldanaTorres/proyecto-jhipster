...
/**
 * REST controller for managing {@link com.jhipster.persona.domain.Libro}.
 */
@RestController
@RequestMapping("/api")
public class LibroResource {
     ...
     */
    @GetMapping("/libros")
    public List<Libro> getAllLibros(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
